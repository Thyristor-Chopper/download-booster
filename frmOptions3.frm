...
Begin VB.Form frmOptions 
      ...
      Begin VB.Frame FrameW9 
         ...
         Begin VB.Frame fError 
            ...
            Begin prjDownloadBooster.CommandButtonW cmdTestError 
               ...
               _extentx        =   661
               _extenty        =   529
               font            =   "frmOptions.frx":04C2
               caption         =   "▶"
            End
            Begin prjDownloadBooster.CommandButtonW CommandButtonW4 
               Height          =   300
               Left            =   4440
               TabIndex        =   100
               Top             =   330
         ...
         Begin VB.Frame fQuestion 
            ...
            Begin prjDownloadBooster.CommandButtonW cmdTestQuestion 
               ...
               _extentx        =   661
               _extenty        =   529
               font            =   "frmOptions.frx":04E6
               caption         =   "▶"
            End
            Begin prjDownloadBooster.CommandButtonW CommandButtonW5 
               Height          =   300
               Left            =   4440
               TabIndex        =   106
               Top             =   330
   ...
   Begin prjDownloadBooster.ImageList imgBrowse 
      ...
      ColorDepth      =   8
      MaskColor       =   16711935
      InitListImages  =   "frmOptions.frx":094C
   End
   Begin VB.PictureBox pbPanel 
      BorderStyle     =   0  '없음
      Enabled         =   0   'False
    ...
    If FolderExists(BackgroundParentDir) Then
        ...
        If hFind <> INVALID_HANDLE_VALUE Then
            Do
                ...
                If CurrentBackgroundLcase = FileNameLcase Then GoTo NextItem
